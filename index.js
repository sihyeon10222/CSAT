...
function getRandomUnified() {
    const days = Math.floor(Math.random() * 1000);
...
// 모바일 도구 팝업
function setupMobileToolPopup() {
    const mobileTimerBtn = document.getElementById('mobileTimerBtn');
    const mobileStopwatchBtn = document.getElementById('mobileStopwatchBtn');
    const mobileToolModal = document.getElementById('mobileToolModal');
    const mobileToolModalClose = document.getElementById('mobileToolModalClose');

    function showMobileToolPopup() {
        if (mobileToolModal) {
            mobileToolModal.classList.add('active');
        }
    }

    function closeMobileToolPopup() {
        if (mobileToolModal) {
            mobileToolModal.classList.remove('active');
        }
    }

    mobileTimerBtn?.addEventListener('click', showMobileToolPopup);
    mobileStopwatchBtn?.addEventListener('click', showMobileToolPopup);
    mobileToolModalClose?.addEventListener('click', closeMobileToolPopup);
    mobileToolModal?.addEventListener('click', (e) => {
        if (e.target === mobileToolModal) closeMobileToolPopup();
    });
}
